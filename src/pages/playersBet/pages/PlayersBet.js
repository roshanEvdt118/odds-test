...
// import PlayersBetForm from '../components/PlayersBetForm';

export default function PlayersBetCreatePage() {
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            {
              name: 'Total Loss',
              href: PATH_DASHBOARD.playersbet.list,
            },
            { name: editView?.playersBet },
          ]}
        />
        {/* <PlayersBetForm
          isEdit={editView?.isEdit}
          isView={editView?.isView}
          currentPlayersBet={state ?? {}} /> */}
      </Container>
    </>
  );
}
